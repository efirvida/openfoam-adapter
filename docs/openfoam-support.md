...
We support mainstream OpenFOAM solvers such as pimpleFoam and solids4Foam for FSI. Our community has, additionally, tried the adapter with multiple different solvers that support function objects.
